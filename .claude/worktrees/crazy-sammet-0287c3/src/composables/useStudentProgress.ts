...
export function useStudentProgress() {
  ...
  /**
   * True if the student has "passed" this lesson under the unlock rules:
   *   – test    → best score ≥ 70
   ...
   *
   * Chain rule: first lesson always unlocked; each subsequent lesson unlocks
   * only when the previous one is passed.  Tests between sections act as
   * natural hard gates — if test-1 isn't passed, nothing after it unlocks.
   */
