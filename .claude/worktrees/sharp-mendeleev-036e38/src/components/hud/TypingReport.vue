  ...
  <div class="hud-panel">
    ...
    <template v-else>
      ...
      <div class="metric-row">
        ...
        <span class="m-val">{{ rollingAvgAccy }}<span v-if="stats.rollingAvgAccy != null" class="m-unit">%</span></span>
      </div>
      ...
      <div class="metric-row class-row">
        ...
        <span class="m-val">{{ classAvgAccy }}<span v-if="stats.classAvgAccy != null" class="m-unit">%</span></span>
      </div>
    </template>
  </div>
</template>
