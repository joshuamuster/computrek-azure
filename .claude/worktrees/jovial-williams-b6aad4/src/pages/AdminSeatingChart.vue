  ...
  <section class="adventure-page">
    ...
    <template v-else>
      ...
      <div class="seating-controls">
        ...
        <!-- Edit / Rotate / Cancel / Save -->
        <div class="chart-actions">
          <!-- Locked mode: ROTATE + EDIT -->
          <template v-if="!isEditing && !isRotating">
            <button
              class="rotate-btn"
              ...
              @click="rotateRows"
            >↑ ROTATE ROWS</button>
            <button class="edit-btn" :disabled="!selectedPeriodId" @click="enterEdit">EDIT</button>
          </template>
