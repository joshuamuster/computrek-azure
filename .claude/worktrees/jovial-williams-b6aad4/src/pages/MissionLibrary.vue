            ...
            <div class="field field--full">
              ...
              <div class="delivery-items-list" v-if="createDraft.deliveryItems.length">
                <div class="delivery-item-row" v-for="(item, i) in createDraft.deliveryItems" :key="i">
                  ...
                  <select v-if="item.kind === 'game'" v-model="item.gameId" class="lcars-input lcars-select di-game-select">
                    <option value="">— Select game —</option>
                    <option v-for="g in GAME_OPTIONS" :key="g.id" :value="g.id">{{ g.label }}</option>
                  </select>
              ...
              <div class="delivery-add-row">
                ...
                <button class="add-item-btn" @click="createDraft.deliveryItems.push({ kind: 'game',  submissionMethod: 'auto', gameId: '' })">+ Game</button>
              </div>
            </div>
          </div>
              ...
              <div class="form-grid">
                ...
                <div class="field field--full">
                  ...
                  <div class="delivery-add-row">
                    ...
                    <button class="add-item-btn" @click="editDraft.deliveryItems.push({ kind: 'game',  submissionMethod: 'auto', gameId: '' })">+ Game</button>
                  </div>
                </div>
              </div>
...
const GAME_OPTIONS = [
  ...
  { id: 'isolinear_easy',        label: 'Isolinear Cascade — Easy' },
  { id: 'isolinear_medium',      label: 'Isolinear Cascade — Medium' },
  { id: 'isolinear_hard',        label: 'Isolinear Cascade — Hard' },
  { id: 'minesweeper_cadet',     label: 'Minesweeper — Cadet' },
  { id: 'minesweeper_standard',  label: 'Minesweeper — Standard' },
  { id: 'minesweeper_red-alert', label: 'Minesweeper — Red Alert' },
  { id: 'warp_easy',             label: 'Warp Core Breach — Easy' },
  { id: 'warp_medium',           label: 'Warp Core Breach — Medium' },
  { id: 'warp_hard',             label: 'Warp Core Breach — Hard' },
]
