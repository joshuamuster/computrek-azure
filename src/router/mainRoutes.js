...
const StudentMissions   = () => import('../pages/StudentMissions.vue');
...
const AdminGames        = () => import('../pages/AdminGames.vue');
...
const FracturedFrontier     = () => import('@/pages/games/FracturedFrontier.vue');
const FracturedFrontierGame = () => import('@/pages/games/FracturedFrontierGame.vue');
...
export const mainRoutes = [
	{ path: '/', component: HomeMain },
	{
		...
		children: [
			...
			{ path: 'users',   component: Settings,           beforeEnter: staffAdminGuard },
		...
		{ path: 'year-end',      component: AdminYearEnd,      beforeEnter: adminGuard },
		],
	},
	{ path: '/videos',    component: VideosPage },
	{ path: '/seating', component: SeatingChart },
	{ path: '/conduct', component: ConductLog },
	...
	{ path: '/flight-plan', component: Missions },
	{ path: '/missions',    component: StudentMissions },
	...
	{ path: '/games/fractured-frontier', component: FracturedFrontier },
	{ path: '/games/fractured-frontier/play', component: FracturedFrontierGame },
