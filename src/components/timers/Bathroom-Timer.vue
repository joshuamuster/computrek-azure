<template>
  <div
    ...
    :class="[isRestrictedNow ? 'bathroom-no' : 'bathroom-yes', { 'bathroom-interactive': isStaff }]"
    ...
    @keydown.space.prevent="isStaff && playFlushSound()"
    @keydown.enter.prevent="isStaff && playFlushSound()"
    :aria-label="isStaff ? (isRestrictedNow ? 'Bathroom Not Available' : 'Bathroom Available') + '. Click to play sound' : undefined"
  >
