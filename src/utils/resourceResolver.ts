...
function fileSegmentDefault(type: string, variant?: string, unitKey?: string): string {
	...
	const isU7 = unitKey === 'unit07';
	switch (type) {
		case 'activityGuide':          return (isU3 || isU5 || isU7) ? 'Handout-ActivityGuide' : 'ActivityGuide';
		case 'activityGuideExemplar':  return (isU3 || isU5 || isU7) ? 'Exemplar-ActivityGuide' : 'Exemplar';
