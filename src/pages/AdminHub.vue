  ...
  <section class="adventure-page">
    ...
    <div v-else class="hub-container">
      ...
      <div class="hub-grid">
        ...
        <div class="hub-card hub-card--seating" @click="go('/admin/seating')">
          <div class="hub-icon">🪑</div>
          <div class="hub-label">Seating Chart</div>
          <div class="hub-desc">Drag and drop cadets into their seats for each period.</div>
        </div>
        ...
        <div class="hub-card hub-card--yearend" v-if="isAdmin" @click="go('/admin/year-end')">
          <div class="hub-icon">📅</div>
          <div class="hub-label">Year-End</div>
          <div class="hub-desc">Archive periods, manage Open Access, and prepare the next school year.</div>
        </div>
...
/* Year-End card — amber/warning tint to signal admin-only significance */
.hub-card--yearend { border-color: rgba(255,153,0,0.15); }
.hub-card--yearend:hover { border-color: rgba(255,153,0,0.45); }
.hub-card--yearend .hub-label { color: #ff9900; }
